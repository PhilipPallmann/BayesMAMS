...
Jaki T, Magirr D, Pallmann P (2015) MAMS: Designing multi-arm multi-stage studies. R package, version 0.6. \href{http://CRAN.R-project.org/package=MAMS}{http://CRAN.R-project.org/package=MAMS}.
