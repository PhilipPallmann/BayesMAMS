...
Dunnett CW (1955) A multiple comparison procedure for comparing several treatments with a control. \textit{Journal of the American Statistical Association}, \textbf{50}(272), 1096--1121.

Whitehead J, Cleary F, Turner A (2015) Bayesian sample sizes for exploratory clinical trials comparing multiple experimental treatments with a control. \textit{Statistics in Medicine}, \textbf{34}(12), 2048-–2061.
